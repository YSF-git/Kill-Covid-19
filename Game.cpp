...
void Game::drawWindow()
{
    ...
    setBackgroundBrush(QBrush(QImage(":/res/images/BG.png")));
...
void Game::endGame()
{
    ...
    for(int i = 0; i < sceneItems.size(); ++i){
        ...
        if( typeid(*tempPtr) == typeid(EnemyVirus) || typeid(*tempPtr) == typeid(Boss)
...
void Game::spawn()
{
    if(wave == 5){
        ...
        int enemyWidth = 100;
        EnemyVirus * enemy1 = new EnemyVirus(scene->width()/2 - 2.5* enemyWidth - 40, 0, enemySpeed);
        EnemyVirus * enemy2 = new EnemyVirus(scene->width()/2 - 1.5*enemyWidth - 20, 0, enemySpeed);
        EnemyVirus * enemy3 = new EnemyVirus(scene->width()/2 - enemyWidth/2, 0, enemySpeed);
        EnemyVirus * enemy4 = new EnemyVirus(scene->width()/2 + enemyWidth/2 + 20, 0, enemySpeed);
        EnemyVirus * enemy5 = new EnemyVirus(scene->width()/2 + 1.5*enemyWidth + 40, 0, enemySpeed);
